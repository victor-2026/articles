...
- Shahid Kamal follow-up (21.09): report format matters — "3 caught, 0 survived" reads as evidence, "100% confidence" as generated marketing. Reply **SENT ✅** 21.09 (`Yes — "3 caught, 0 survived" is falsifiable, "100% confidence" isn't. One tells you what to verify next, the other says there's nothing to verify. Verdict vs vibe.`)
