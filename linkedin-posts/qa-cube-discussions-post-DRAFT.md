...
**Status:** POSTED 24.09 ✅ — first discussion in codecube01/qa-cube (Show and tell #2): https://github.com/codecube01/qa-cube/discussions/2. On article-B publish: EDIT body (add link).
